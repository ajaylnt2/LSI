angular.module('lsi').controller('fortinentpmappophotspotCtrl', function ($scope, fortinetService) {
                    ...
                    $scope.$watch('selectedDate', function() {                  
                        if($scope.selectedDate == '' || $scope.selectedDate == null){
                           ...
                           $scope.kpiChangeValue();
                            console.log($scope.accePointData);
                        }
                    });
	...
	$scope.kpiChangeValue = function () {
        ...
        for(var i=0;i<lastWeeksDate.length; i++)
        {
        	...
        	fortinetService.getPopularityHotspotKPI ( $scope.accePointData, lwd, function (response) {
        ...
        setTimeout(function() { $scope.popularityHotspotKPI(); }, 3000);              
    ...
    $scope.popularityHotspotKPI = function () {
        ...
        fortinetService.getPopularityHotspotKPI ( $scope.accePointData, $scope.selDate, function (response) {
