    ...
    $scope.loadWifiAnalytics = function(){
    	...
    	fortinetService.getFortinentTree(function (res) {
            if(res.status == "failure"){
				...
				var captureData = {"branchs":[],"stores":[$scope.storeId],"flors":[],"accessPoints":[],"conf":{"accessPoints":[],"areas":[],"distanceInMeters":"5","dwellTimeOfEmployee":28800000,"endTimeInMsec":parseInt(endDate),"engagedTimeInMsec":1200000,"filterDeviceOUIs":true,"filterEmployees":true,"filterFixEquipment":true,"filterRandomMacs":true,"filterSubSumpling":false,"minDateForNewVsRep":parseInt(dateForNewVsRep),"minValOfObsFixEquipment":"1000","resolution":"DAY","startTimeInMsec":parseInt(startDate),"subSamplingNumber":"3","tableName":"mostRecentPositionWeightedAverage","timeToMergeInMsec":300000,"visitedTimeInMsec":180000}};
				
        		fortinetService.getNewVsRepeat(captureData, function(response) {
